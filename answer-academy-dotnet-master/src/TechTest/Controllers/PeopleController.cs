...
namespace TechTest.Controllers
{
    ...
    public class PeopleController : ControllerBase
    {
        ...
        public IActionResult GetAll()
        {
            ...
            if (person == null)
            {
                return Ok (new System.Collections.Generic.List<Person>());
            }

            return Ok(this.PersonRepository.GetAll());
        ...
        public IActionResult Get(int id)
        {
            ...
            return Ok(this.PersonRepository.Get(id));
        ...
        public IActionResult Update(int id, PersonUpdate personUpdate)
        {
            ...
            return Ok(this.PersonRepository.Update(person));
